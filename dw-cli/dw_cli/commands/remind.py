...
def update_remind(
    ...
    baseline_ids: str = typer.Option(None, "--baseline-ids", help="基线 ID，逗号分隔"),
    biz_process_ids: str = typer.Option(None, "--biz-process-ids", help="业务流程 ID，逗号分隔"),
    ...
    _call(ctx, "update_remind", dw_models.UpdateRemindRequest(
        ...
        alert_unit=alert_unit, node_ids=node_ids,
        baseline_ids=baseline_ids, biz_process_ids=biz_process_ids,
