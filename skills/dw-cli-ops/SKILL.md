...
| 风险等级 | 命令 | 规则 |
|---|---|---|
| 只读 | get-node, get-node-code, get-node-parents, get-node-children, list-nodes, list-nodes-by-output, list-node-input-or-output, get-instance, get-instance-log, list-instances, list-instance-history, list-instance-amount, list-success-instance-amount, top-ten-elapsed-time-instance, top-ten-error-times-instance, get-instance-status-statistic, get-dag, list-manual-dag-instances, list-alert-messages, list-inner-nodes, list-dags, list-file-type, get-remind, list-reminds, get-topic, get-topic-influence, list-topics | 直接执行 |
| 低危 | restart-instance, resume-instance, suspend-instance, update-node-run-mode, update-node-owner, run-cycle-dag-nodes, run-manual-dag-nodes, run-trigger-node, run-smoke-test, create-remind, update-remind | 默认执行，建议先确认参数 |
